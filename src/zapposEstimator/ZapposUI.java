...
public class ZapposUI extends javax.swing.JFrame {
    ...
    public ZapposUI() {
        ...
        ImageIcon icon = new ImageIcon(ClassLoader.getSystemResource("images/Zappos.png"));
        jLabel3.setIcon(icon);
        jPanel1.setBackground(Color.decode("#FFB6C1"));
    ...
    private void EstimateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EstimateActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Not a proper number format in cost field", "Error", WIDTH);
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Not a proper number format in number of products", "Error", WIDTH);
